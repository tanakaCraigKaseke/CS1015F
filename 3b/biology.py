...
has_backbone = input('Does the organism have a backbone? (yes/no):\n').strip().lower()
...
if has_backbone == 'yes':  # Vertebrate
    ...
    has_exoskeleton = input('Does it have an exoskeleton? (yes/no):\n').strip().lower()
...
# Fix "a/an" issue
article = 'an' if organism_classification[0].lower() in 'aeiou' else 'a'
print(f'It is {article} {organism_classification}.')